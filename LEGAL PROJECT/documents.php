...
<body>
  <header>
    ...
    <li class="nav-item">
      <a class="pendo-subnav-recent-activity nav-link active" href="intake_documents.html">Intake Documents</a>
    </li>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-body">
                    ...
                    <form action="php/filemanager.php" method="POST" enctype="multipart/form-data">
