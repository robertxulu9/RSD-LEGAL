        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="home page.php" role="button" data-bs-toggle="dropdown"
                aria-expanded="false">
                Home
              </a>
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="home page.php">Dashboard</a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="contacts.php">People</a></li>
                <li><a class="dropdown-item" href="companies.php">Companies</a></li>
              </ul>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="cases.php">Open Cases</a></li>
                <li><a class="dropdown-item" href="closed cases.php">Closed Cases</a></li>


              </ul>
            </li>
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="cases.php" role="button" data-bs-toggle="dropdown"
                aria-expanded="false">
                Documents
              </a>
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="documents.php">Case Documents</a></li>
                <li><a class="dropdown-item" href="firm documents.php">firm Documents</a></li>
